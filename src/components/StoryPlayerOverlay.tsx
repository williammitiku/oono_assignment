  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 sm:relative sm:z-[58] sm:flex-1 sm:min-h-0 flex flex-col items-stretch justify-center sm:items-center sm:px-4 z-[58]">
        <div className="relative w-full h-full min-h-0 flex-1 sm:h-[90vh] sm:max-h-[90vh] sm:aspect-[9/16] sm:w-auto sm:flex-none flex flex-col">
          <button
            type="button"
            onClick={onClose}
          ...
          <div className="flex-1 min-h-0 w-full bg-black flex flex-col overflow-hidden relative">
